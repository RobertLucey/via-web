...
.search-results {
  ...
  margin: 4px 0;
  background: white;
  box-shadow: 0 6px 24px #243b4533;
  border-radius: 8px;
  max-height: 300px;
  overflow: auto;
}
...
.map-status {
  ...
  padding: 12px 18px;
  border-radius: 8px;
  box-shadow: 0 2px 12px #243b4522;
  max-width: calc(100% - 110px);
}
.error {
  border-left: 4px solid #aa4036;
}
.legend,
.road-details {
  position: absolute;
  z-index: 1000;
  background: white;
  box-shadow: 0 3px 18px #243b4533;
  border-radius: 10px;
  padding: 16px;
}
.legend {
...
.legend-gradient.roughness-gradient {
  background: linear-gradient(
    to right,
    #1a9850,
    #91cf60,
...
.about-panel {
  ...
  padding: 24px;
  background: white;
  box-shadow: 0 4px 30px #243b4544;
  border-radius: 12px;
}
@media (max-width: 700px) {
  ...
  .map-area:has(.road-details) .legend {
    display: none;
  }
  .table-heading span {
    display: none;
